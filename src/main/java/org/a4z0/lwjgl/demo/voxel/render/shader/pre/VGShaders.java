package org.a4z0.lwjgl.demo.voxel.render.shader.pre;

import org.a4z0.lwjgl.demo.voxel.render.shader.Shader;
import org.a4z0.lwjgl.demo.voxel.render.shader.ShaderProgram;
...
public class VGShaders {
    ...
    static {
        ...
        }
        {
            ...
            TEXT_VERTEX_SHADER.source(getSource("assets/shaders/text.vert"));
            TEXT_VERTEX_SHADER.compile();

            // Fragment
            Shader TEXT_FRAGMENT_SHADER = new Shader(GL_FRAGMENT_SHADER);
            TEXT_FRAGMENT_SHADER.source(getSource("assets/shaders/text.frag"));
