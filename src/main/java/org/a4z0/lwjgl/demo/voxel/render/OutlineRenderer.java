...
import org.a4z0.lwjgl.demo.voxel.vertex.VertexBuffer;
...
public class OutlineRenderer {
    ...
    /** Represents the bounding edges of a {@link IChunk}. */
    public static final AABB BOUNDARIES = new AABB(IChunk.CHUNK_SIZE_X -1, IChunk.CHUNK_SIZE_Y -1, IChunk.CHUNK_SIZE_Z -1, -1, -1, -1);
    ...
    */
    ...
    public void render(IChunk chunk, float r, float g, float b, float a, float w) {
